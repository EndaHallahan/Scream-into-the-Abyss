/* Modified from pinhole-js created by Josh Baker (tidwall) | https://github.com/tidwall/pinhole-js */
const Pinhole = (function(){
	function Pinhole(){
		this.lines = [];
		this.stack = [];
	}
	...
	Pinhole.prototype.drawSquare = function(minx, miny, minz, maxx, maxy, maxz) {
